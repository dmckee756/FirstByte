...
abstract class FirstByteSQLConstants {
    ...
    companion object Creation {
        ...
        //Used on initial database creation, for a easier and prettier creation method.
    ...
    /**
     * Table and columns names in the component Table.
     * component_name is the primary key of all components in the database.
     */
    ...
    /**
     * Table and columns names in the gpu Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    ...
    /**
     * Table and columns names in the cpu Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    ...
    /**
     * Table and columns names in the ram Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    interface RamSticks {
        companion object {
    ...
    /**
     * Table and columns names in the psu Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    ...
    /**
     * Table and columns names in the storage Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    ...
    /**
     * Table and columns names in the motherboard Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    ...
    /**
     * Table and columns names in the cases Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    interface Cases {
        companion object {
    ...
    /**
     * Table and columns names in the heatsink Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    interface Heatsinks {
        companion object {
    ...
    /**
     * Table and columns names in the fan Table, it's name is a foreign key from the component table
     * and will be deleted if the component_name from the component table is deleted.
     */
    interface Fans {
        companion object {
    ...
    /**
     * Table and columns names in the pcbuild Table.
     * The Primary Key is an autogenerated integer and each [COMPONENT]_name
     * is a foreign key reference from the corresponding component table.
     * These keys act as a 0..1 relationship between the pc and the components.
     */
    interface PcBuild {
        companion object {
    ...
    /**
     * Table and columns names in the ram_in_pc Table, it's name is a foreign key from the ram table and
     * the pc_id is a foreign key from it's pcbuild table.
     * This table is a many-to-many relationship between ram and pcbuilds.
     * Currently there can only be 2 slots of ram for each pc.
     */
    interface RamInPc {
        companion object {
    ...
    /**
     * Table and columns names in the storage_in_pc Table, it's name is a foreign key from the storage table and
     * the pc_id is a foreign key from it's pcbuild table.
     * This table is a many-to-many relationship between storage and pcbuilds.
     * Currently there can only be 3 slots of storage for each pc.
     */
    ...
    /**
     * Table and columns names in the fan_in_pc Table, it's name is a foreign key from the fan table and
     * the pc_id is a foreign key from it's pcbuild table.
     * This table is a many-to-many relationship between fan and pcbuilds.
     * The amount of fan slots depend on the number of fans the case and heatsink that's a part of the pc can hold.
     */
    interface FansInPc {
        companion object {
    ...
    /**
     * A table dedicated to holding the unique varchar id for a comparing many-to-many table.
     * I.e Comparing Graphics Cards is a unique compare table, and a unique identifier in the compare_stats
     * table to find only Graphics cards that are being compared and load them.
     */
    interface Compare{
        companion object{
    ...
    /**
     * This is a many-to-many relationship between the component table and the unique identifier table "compare".
     * Used to store 0 or many component names and assign them to their correct compare table.
     * E.g. Gpu's can only be compared with Gpu's has it's assign to the Gpu Primary Key in the compare table. A Gpu cannot be compared with any Cpu's or Ram and vice versa.
     */
